<template>
  <div>
    ...
    <div class="mt-4">
      <p class="text-muted fs-6 text-center fst-italic">No Analytics to Display</p>
    </div>
    <div v-if="false">
      <div class="row mt-4">
        <div class="col-sm-3 text-center mb-3 mb-sm-0">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text fs-1 fst-italic">47%</p>
            </div>
          </div>
        </div>
        <div class="col-sm-3 text-center mb-3 mb-sm-0">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-normal">Bounce Rate</h5>
        ...
        <div class="col-sm-3 text-center mb-3 mb-sm-0">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text fs-1 fst-italic">4.5 min</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-4">
        ...
        <div class="col-sm-7 text-center mb-3 mb-sm-0">
          <div class="card">
            <div class="card-body row">
              <div class="col-md-4">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <div class="card">
            <div class="card-body text-center">
              <h5 class="card-title fw-normal">Device Browser</h5>
              <p class="card-text fs-1 fst-italic">
                <PieChart
                  class="p-4"
                  :width="200"
                  :height="200"
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body text-center">
              <h5 class="card-title fw-normal">Device OS</h5>
              <p class="card-text fs-1 fst-italic">
                <PieChart
                  class="p-4"
                  :width="200"
                  :height="200"
                  :chartData="{
                    labels: ['Andriod', 'iOS', 'Windows', 'Linux', 'Other'],
                    datasets: [
                      {
                        backgroundColor: [
                          '#41B883',
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body text-center">
              <h5 class="card-title fw-normal">Device Type</h5>
              <p class="card-text fs-1 fst-italic">
                <PieChart
                  class="p-4"
                  :width="200"
